<?php
	...
	class UploadImagem{
		...
		// Definida no arquivo index.php, será a largura máxima da nossa imagem
		private $width;
		
		// Definida no arquivo index.php, será a altura máxima da nossa imagem
		private $height;
		...
		// Nossos tipos de imagem disponíveis para este exemplo
